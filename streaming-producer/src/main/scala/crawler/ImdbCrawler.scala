...
class ImdbCrawler(producer: KafkaProducer[String, String]) extends Crawler {
  private[this] val CSV_PATH = "/phim_raw_05102017.csv"
  private[this] val SEPERATOR = "\t "
  private[this] val XPATH = Map(
  ...
  private[this] def parse(tempResult: Map[String, String]): String = {
  ...
  private[this] def getOriginTitles(csvPath: String): List[String] = {
  ...
  private[this] def genUrl(text: String): String ={
